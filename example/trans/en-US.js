...
export default {
  ...
  home_contact_text : "Want to know more about our solutions? Talk to our experts.",
  home_contact_footer : "I agree to the use of my personal data by Atom 8 to send me marketing materials in accordance with the terms of Atom 8‘s &lt;a&gt;Data Privacy Policy.&lt;/a&gt;",
  ...
  home_banner_text : "One-stop solution for all your business needs in the digital asset space.",
  ...
  home_partners_head : "We partner with industry leading companies across the ecosystem.",
  ...
  how_faq_inv_a_3_2_3 : "Example: &lt;a href=&#34;https://slate.com/technology/2019/12/quadriga-gerald-cotten-death-cryptocurrency.html&#34; target=&#34;blank&#34;&gt;https://slate.com/technology/2019/12/quadriga-gerald-cotten-death-cryptocurrency.html&lt;/a&gt;",
  ...
  sto_nolist_privacy : "We&#39;re committed to your privacy. Atom 8 will use your contact information to contact you about digital asset related projects, products, and services. By clicking submit, you permit Atom 8 to use and share your data in the means set out in our &lt;a href=&#39;../resources/pdf/Atom8_Data_Privacy_Policy.pdf&#39; target=&#39;_blank&#39;&gt;Data Privacy Policy&lt;/a&gt; and &lt;a  href=&#39;../resources/pdf/Atom8_Cookies_Policy.pdf&#39; target=&#39;_blank&#39;&gt;Cookies Policy.&lt;/a&gt;. You may unsubscribe from these communications by clicking the unsubscribe button at the button of our emails.",
  ...
  who_manage_KenLo_desc : "10+ years of experience in global corporations and early stage startups, incl. HSBC, McKinsey, ZA International",
  who_manage_xiaochuan : "Xiaochuan Wu",
  who_manage_xiaochuan_desc : "8+ years of experience in blockchain and crypto assets development with leading tech companies incl. Huobi, ZhongAn ",
  who_manage_yueCheng : "Yue Cheng",
  who_manage_yueCheng_desc : "15+ years of experience in software engineering with leading tech companies incl. Nokia, Blackberry, Arris",
  who_manage_Jonathan : "Jonathan Cheung",
  who_manage_Jonathan_desc : "10+ years of experience in product development and pricing in major financial institutions incl. Manulife, FWD, ZA International ",
  ...
  contact_submit_success : "Thank you for your enquiry, we will get back to you soon.",
  ...
  our_capital : "We work with issuers to enable a new avenue to capital markets.",
  ...
  our_hottitle : "We offer safe and secure wallet infrastructural solutions to issuers and licensed custodians.",
  our_cold : "Hot &amp; cold wallet solutions",
  our_storage : "Wallet storage set-up and development",
  our_chain : "Institutional-grade Hardware Security Module (HSM) vaults (Level 2)",
  our_integration : "Integration capability with different exchanges and blockchains",
  our_encryption : "Symmetric (AES, SM1 &amp; SM4) and asymmetric (RSA, ECDSA-256k1, SM2) key encryption algorithms",
  our_RegTech : "RegTech (coming soon)",
  our_enable : "We provide digital asset trading platforms with robust compliance solutions:",
  our_auditing : "KYC/AML protocols: help implement Financial Action Task Force (FATF) Recommendations",
  our_version : "",
  our_testing : "",
  our_deployment : "",
  our_kyc : "Web surveillance and monitoring: detect any system and usage abnormalities ",
  our_transaction : "",
  our_adverse : "",
  our_market : "Other RegTech software solutions: automation and business intelligence tools to increase operational efficiency",
  our_artifical : "",
  our_realtime : "",
  footer_agrement : "User Agreement",
  sto_want : "Investing in security tokens",
  sto_build : "By working with global security token exchanges, we allow investors to access global markets.",
  ...
  sto_stoken_what_txt : "Security Tokens are digital representations of ownership of assets or economic rights, created via blockchain technology. They are widely regulated as securities in major jurisdictions worldwide.  ",
  sto_stoken_issue : "Why issue a Security Token",
  sto_stoken_issue_txt1 : "Security token offerings are a new fundraising channel that complement the current capital markets through:",
  sto_stoken_issue_txt2 : "Existing capital raising processes = high costs",
  sto_stoken_cumber : "Cumbersome regulations",
  sto_stoken_minimum : "Minimum profit threshold requirements and rigid shareholder structures",
  sto_stoken_ownership : "Ownership verification",
  sto_stoken_difficult : "Difficult to trace back and reach ultimate beneficial holders",
  ...
  sto_stoken_public : "Public securities (T+2), private investments (can extend for months)",
  sto_stoken_security : "Security token offerings (STOs) create a new fundraising channel to IPOs.",
  sto_stoken_why : "Why consider issuing a security token?",
  sto_stoken_asset : "Asset types (illustrative)",
  sto_stoken_unprecedented : "Unprecedented liquidity to early-stage/ pre-revenue companies",
  sto_stoken_pe : "PE/VC fundraising &amp; exits",
  sto_stoken_standard : "Tokenizing standardized LP terms (without side letter) allow GPs to more efficiently distribute to investors, and for investors to transfer LP interests",
  ...
  sto_stoken_retain : "Retain flexibility and control while mobilizing company assets",
  sto_stoken_sme : "SME financing",
  sto_stoken_account : "Tokenizing account receivables without diluting equity",
  sto_stoken_eg : "e.g. (Real estate) Tokenizing only economics rights (e.g. office lease) while retaining ownership/ access rights",
  ...
  sto_stoken_group : "e.g. entertainment groups, horses, fine wine, pink diamonds, etc.",
  sto_stoken_fractionalization : "Fractionalization lowers investment threshold",
  sto_stoken_efficiency : "Operational efficiency and immutability of assets on blockchain",
  ...
  secur_empo : "Monetizing private market assets, SME financing, IP rights and collectibles",
  secur_unpr : "Unparalleled liquidity",
  secur_pe : "PE/VC fundraising &amp; exits",
  secur_letter : "e.g., LP interests: tokenizing standardized LP terms allows GPs to more efficiently distribute tokens to investors, and for investors to sell LP interests to existing/ new investors",
  ...
  secur_token : "e.g., real estate: tokenizing only the economics rights of assets (e.g. office lease), while retaining ownership/ access rights",
  secur_access : "Operational efficiency and immutability of records on blockchain",
  secur_lower : "",
  ...
  wallet_bit : "BitGo’s wallet platform creates an ideal balance between security and accessibility—enabling clients to move assets seamlessly and reliably, protected by BitGo’s pioneering multi-signature security, multi-user policy controls, and advanced security configurations.",
  wallet_secur : "Security designed to fit your needs",
  wallet_bitgo : "BitGo offers flexible wallet security and transaction policy features to address a range of business needs. Protect your wallet against any single point of failure with BitGo&#39;s multi-signature security and 3-key management. Enforce controls and policies using whitelists, velocity limits, and administrative approvals.",
  wallet_soc : "SOC 2 Type 2",
  wallet_offer : "We offer safe and secure wallet infrastructural solutions to Issuers and Licensed Custodians.",
  ...
  wallet_enable : "We enable digital asset trading platforms establish leading exchange platforms with regulatory solutions.",
  wallet_recovery : "Key recovery service (KRS) insurance for self-custodied keys are available through a trusted third-party provider. Protect your digital assets against loss or theft and have total peace of mind.",
  wallet_solution : "Our wallet solutions offer…",
  wallet_solution_info1 : "Institutional-grade Hardware Security Module (HSM): Safeguards client private keys in an offline environment",
  wallet_solution_info2 : "Technical integration: Provide client-ready solutions to digital asset exchanges and licensed custodians",
  wallet_solution_info3 : "Secure storage: Symmetric and asymmetric encryption standards deployed",
  wallet_solution_info4 : "Support for multiple assets: Cryptocurrencies, security tokens, DeFi tokens and NFTs",
  wallet_title02 : "Servicing virtual asset storage: &lt;br/&gt;Secure and safe.",
  wallet_title03 : "Wallet solutions for individual/ institutional investors and licensed custodians.",
  wallet_digital : "Digital asset wallets…",
  wallet_digital_txt : "allow users to manage and trade their digital assets in a secure environment.",
  who_title_box1 : "Atom 8 provides tech solutions for the digital asset ecosystem.",
  who_title_box2 : "Atom 8 Limited (“Atom 8”) is a technology-services provider offering a range of solutions for security token creation, token life cycle management, wallet services and RegTech solutions.",
  home_title : "Unlocking new opportunities with cutting-edge technology",
  home_step : "One-stop solution for all your business needs in the digital asset space.",
  ...
  home_secur : "Security tokens are regulated as “securities” in US, UK, Japan and Hong Kong",
  home_partners : "Our partners",
  home_partners_txt : "We partner with industry leading organizations across the ecosystem.",
  home2_stos : "We provide a full suite of technology services for the digital asset space",
  ...
  home2_fill : "As a full-suite technology services provider, we fill the technical gap in the market as a one-stop shop, offering:",
  ...
  home2_ex : "Expertise",
  home2_ex_txt : "across different technology sectors, including engineering capabilities on blockchain and smart contracts",
  home2_enab : "Enable",
  home2_enab_txt : "a clear pathway to listing in various jurisdictions",
  home2_Ecosystem : "End-to-end tech support",
  home2_Ecosystem_txt : "along the IDO, IEO and STO journey from designing tokenomics to post-listing token actions post-listing",
  ...
  regtech_title3 : "Your digital asset partner for comprehensive compliance solutions.",
  regtech_title4 : "RegTech…",
  regtech_title5 : "",
  regtech_title6 : "are technology solutions to streamline regulatory compliance.",
  regtech_title7 : "RegTech allows you to operate a more effective and compliant business:",
  ...
  faq_title1 : "General",
  faq_general_question1 : "Is Atom 8 licensed under the Hong Kong Securities and Futures Commission (SFC)?",
  faq_general_answer1 : "Atom 8 is a technology solution provider assisting SFC Regulated Activities (RA) licensees, issuers, and other companies with their technology needs. We do not conduct any regulated activities.",
  faq_general_question2 : "Can issuers, fund admins, custodians etc. partner with Atom 8 and become part of the ecosystem?",
  faq_general_answer2 : "Atom 8 strongly believes in open partnerships and upholds an open-to-collaboration mindset. If you are interested in becoming part of the digital asset ecosystem, please contact us at support@atom8.com.hk.",
  faq_general_question3 : "I am interested in using Atom 8’s services and/or products. What are the fees and where can I get more information?",
  faq_general_answer3 : "Our fees vary based on the services or products subscribed for. Please contact us at support@atom8.com.hk so we can better understand your needs and give you an appropriate quote.",
  faq_title2 : "Tokens 101",
  faq_general_question5 : "What is tokenization?",
  faq_general_answer5 : "Tokenization is the process of digitizing ownership a real-world asset or right into a token on the blockchain.",
  faq_general_question6 : "What types of tokens are there?",
  faq_general_answer6 : "There are many types of tokens in the digital asset space; the following 4 tokens are the most common types.",
  faq_general_answer6_1 : "1. Cryptocurrencies",
  faq_general_answer6_2 : "Cryptocurrencies can be used for payments and can be traded on cryptocurrency exchanges for other currency tokens or fiat currencies. The most typical examples of cryptocurrencies are Bitcoin and Ethereum.",
  faq_general_answer6_3 : "2. Security Tokens",
  faq_general_answer6_4 : "Security tokens are digital representations of ownership of assets (e.g., gold, real estate) or economic rights (e.g., a share of profits or revenue). In Hong Kong, they are regulated as securities by the Hong Kong Securities and Futures Commission (SFC), under the Securities and Futures Ordinance (SFO).",
  faq_general_answer6_5 : "3. Non-Fungible Tokens (NFT)",
  faq_general_answer6_6 : "Non-fungible tokens are tokens backed by unique assets, they are not interchangeable and are non-divisible. Some common assets examples of assets that have been tokenized into NFTs include intellectual property rights, artwork, and collectibles. For example, Twitter co-founder Jack Dorsey’s first tweet was sold as an NFT for USD 2.9 million.",
  faq_general_answer6_7 : "4. Utility Tokens",
  faq_general_answer6_8 : "Utility tokens are not considered an investment and are not usually traded. These are typically user tokens or in-app coins, which can be used in exchange for platform services.",
  faq_general_question7 : "What is the difference between a security token and an STO?",
  faq_general_answer7 : "Security tokens are a type of token, and are regulated as securities in Hong Kong by the SFC. Meanwhile, STOs are an offering of security tokens to qualified investors.",
  faq_general_question8 : "Are STOs the same as ICOs?",
  faq_general_answer8 : "ICOs, or initial coin offerings, are offerings of tokens, some of which may be security tokens. As such, some ICOs of security tokens may not comply with relevant securities rules and regulations and could constitute an illegal offering in those jurisdictions. An STO is an offering of security tokens, which are regulated vendor with relevant securities rules and regulations. In an STO, investors invest in security tokens recorded on a blockchain.",
  ...
  faq_general_answer11 : "According to global law firm Norton Rose Fulbright, smart contracts are “self-executing transactions, written in computer code and performed in an automated way”. The smart contracts lay down the execution logic and predetermined actions, and these are automatically executed when the codes are triggered.",
  faq_general_question12 : "What is the difference between public vs. permissioned blockchain?",
  ...
  faq_general_answer13 : "Blockchain or the Distributed Ledger Technology open up new opportunities in various scenarios. It facilitates collaboration and partnerships within different ecosystems.",
  faq_general_answer13_1 : "Outside of crypto-assets and fund raising, the top use case of blockchain is in trade finance.",
  faq_general_answer13_2 : "Traditionally, banks do not provide supply chain financing to SMEs as they are unable to verify whether their clients’ collateral has previously been used as collateral with other banks. This leads to the duplicate financing problem, as banks may unknowingly provide financing services to clients against collateral that is already leveraged. However, by utlising cryptographic elements of the blockchain, banks can be more confident in dealing with a new range of clients. Examples of trade finance blockchain projects include eTradeconnect in Hong Kong and We.trade in Europe.",
  faq_title4 : "For issuers/ sponsors",
  faq_general_question14 : "How is a security token regulated in Hong Kong?",
  faq_general_answer14 : "Security tokens are regulated as securities under the Securities and Futures Ordinance (SFO) in Hong Kong by the SFC.",
  faq_general_question15 : "What are the benefits of raising funds through STOs?",
  faq_general_answer15 : "STOs provide companies with an additional fundraising channel, regardless of a company’s size and maturity. The listing requirements and costs of an STO are much lower than an IPO on the Hong Kong Stock Exchange, making it more practical for early-stage/ small or mid-cap companies to gain access the capital markets. Companies can benefit from STOs in two major use cases:",
  faq_general_answer15_1 : "•	Pre-IPO: increase liquidity of their securities and transparency of their valuation.",
  faq_general_answer15_2 : "•	Project financing (pre-/post-IPO): automating certain administrative actions (e.g., reporting, coupon distribution) to facilitate speedy and low-cost settlements.",
  faq_general_question16 : "I need an advisor to engage for an STO, how and who should I engage?",
  faq_general_answer16 : "In preparation for an STO, issuers will need to engage, at a minimum, a technology solutions provider, financial advisor, legal advisor, auditor, and tax advisor to assist in security token structuring, due diligence, offering disclosure preparation and security token distribution. Atom 8 has an extensive network of advisors within our ecosystem, and we can make introductions to help you find your required service providers. Please contact us at support@atom8.com.hk for further details.",
  faq_general_question17 : "What are Atom 8’s services fees for issuers?",
  faq_general_answer17 : "Atom 8 provides Token Creation, Token Management SaaS (software as a service), Wallet solutions and RegTech solutions. Fees vary across services and the underlying asset types. Please contact us at support@atom8.com.hk for further details.",
  faq_general_question18 : "I am an issuer located in Hong Kong. Can I sell a security token outside of Hong Kong?",
  faq_general_answer18 : "Yes, you can. Atom 8 has an extensive network of ecosystem participants both locally in Hong Kong and overseas – connecting you with the most suitable parties, such as advisors and regulated exchanges.",
  faq_general_answer18_1 : "Conversely, if you are an issuer located overseas, you can also issue a security token in Hong Kong by leveraging Atom 8’s network and expertise.",
  faq_general_answer18_2 : "All security token sales, trading and listing are subject to compliance with relevant laws and regulations of the respective jurisdiction.",
  faq_general_question19 : "How long does it take to issue a security token?",
  faq_general_answer19 : "This will depend on the complexity of the asset to be tokenized, specific token structure requirements and the due diligence process. We envision it will take around 2 to 3 months from the moment you engage us through to completion of due diligence and the finalization of the offering document.",
  faq_general_question20 : "Do I need in-house blockchain team to issue security tokens?",
  faq_general_answer20 : "Do not worry if you do not have an in-house blockchain team – Atom 8 has the technical delivery capabilities and an extensive network of ecosystem participants to provide you with the necessary support to issue security tokens.",
  faq_general_answer20_1 : "If you have an in-house blockchain team and wish to issue a security token, please contact us at support@atom8.com.hk to discuss next steps.",
  faq_general_question21 : "Do I need a digital asset wallet to issue security tokens?",
  faq_general_answer21 : "Atom 8 provides an end-to-end security token solution that allows you to store your tokens within a secure digital asset custodian within Atom 8’s ecosystem. Please contact us at support@atom8.com.hk for more details.",
  faq_title5 : "For investors",
  faq_general_question22 : "How is a security token regulated in Hong Kong?",
  faq_general_answer22 : "Security tokens are regulated as securities under the Securities and Futures Ordinance (SFO) in Hong Kong by the Securities and Futures Commission (SFC).",
  faq_general_question23 : "Who can invest in security tokens?",
  faq_general_answer23 : "Under the Statement on Security Token Offerings published by the SFC on 28 March 2019, only “Professional Investors” as defined under the SFO can invest in security tokens.",
  faq_general_answer23_1 : "Professional Investors are defined as:",
  faq_general_answer23_2 : "•	High net-worth individuals with a portfolio of not less than HKD 8 million; or",
  faq_general_answer23_3 : "•	A trust corporation/ partnership with a portfolio of not less than HKD 8 million or with total assets of not less than HKD 40 million",
  faq_general_question24 : "I am a Professional Investor based outside of Hong Kong. Can I invest in security tokens listed in Hong Kong?",
  faq_general_answer24 : "Prospective investors must comply with all relevant rules and regulations, including securities regulations in Hong Kong and the jurisdiction of their residence. In addition, investors must be onboarded on a licensed virtual asset exchange platform in Hong Kong.",
  faq_general_question25 : "What are the technological advantages of a security token?",
  faq_general_answer25 : "1.	Accessibility",
  faq_general_answer25_1 : "With costs of fractional ownership lowered by asset tokenization, more investors can invest in PE/VC funds, real property, and rare commodities without increasing their fundraising costs.",
  faq_general_answer25_2 : "2.	Credibility ",
  faq_general_answer25_3 : "The blockchain architecture ensures immutability and fault-tolerance of trading records of security tokens. With corresponding security protocols in place, it is virtually impossible to tamper with records, providing confidence and credibility to investors. This feature is especially critical for collectibles where provenance of the asset must be proven.",
  faq_general_answer25_4 : "3.	Efficiency in corporate actions",
  faq_general_answer25_5 : "With the implementation of “smart contracts,” corporate administrative actions such as dividend pay-out can be automated. Efficiency can be enhanced, and corresponding administrative costs can also be lowered.",
  faq_general_question26 : "What are the risks associated with investing in security tokens?",
  faq_general_answer26_1 : "1.	Key Management",
  faq_general_answer26_2 : "In the digital asset space, your private key is the only proof of ownership to your crypto-assets. Failing to manage private keys properly may result in total loss of value of your investment.",
  faq_general_answer26_3 : "2.	Service Provider Risk",
  faq_general_answer26_4 : "Tokens are traded on exchanges and held by custodians. Investors might suffer substantial losses if these service providers materially default in their obligations.",
  faq_general_answer26_5 : "There are also other risks to consider, such as volatility and liquidity risks, which are analogous to conventional securities.",
  faq_general_question27 : "Where are my security tokens stored?",
  faq_general_answer27 : "Security tokens will be stored with a secure digital asset custodian within Atom 8’s ecosystem. Investors may store their security tokens in the custodian by opening an account. Please contact us at support@atom8.com.hk for more details.",
  faq_general_question28 : "How do I trade security tokens?",
  faq_general_answer28 : "In Hong Kong, security tokens can only be traded on an SFC licensed virtual asset exchange. To learn more about security token projects undertaken by our exchange partners within our ecosystem, please visit our “ST Project” page &lt;a href=&#34;/our/stlist&#34; style=&#34;display:inline;&#34;&gt;here&lt;/a&gt;.",
  faq_title6 : "Hot &amp; Cold Wallet Solutions",
  faq_general_question29 : "What is a “public key” and “private key”? How do they keep wallets secure?",
  ...
  faq_general_answer30 : "Digital asset wallets can be divided into hot and cold wallets.",
  faq_general_answer30_1 : "Hot wallets are connected to the internet (e.g., desktop wallet, mobile apps) while cold wallets are not (e.g., paper wallets and hardware wallets). In terms of cybersecurity, cold wallets are considered a safer option as private keys are less susceptible to hackers when compared to hot wallets, thus minimising the risk of theft of digital asset.",
  faq_general_answer30_2 : "Due to the differences in wallet nature, active digital asset traders often prefer hot wallets as they are connected to the internet and enable active monitoring and transactions of digital assets. Cold wallets are often used for long-term digital asset storage.",
  faq_general_question31 : "What is AES-256?",
  faq_general_answer31 : "Advanced Encryption Standard (AES) is an encryption standard used to encrypt data. Data is encrypted into a fixed, 128-bit block size during the AES encryption process. These blocks can be encrypted and decrypted with keys. There are a total of three key lengths of 128-, 192- and 256-bits, each used to decipher messages from AES-128, AES-192 and AES-256 respectively.",
  faq_general_answer31_1 : "AES-256 is currently the most widely adapted AES due to its high levels of security. The length of a 256-bit key makes it extremely difficult to crack due to the huge number of possible key combinations (1.1 x 1077 key combinations) created.",
  faq_general_question32 : "Who can use Atom 8 wallet solutions?",
  faq_general_answer32 : "Atom 8 provides wallet solutions to Individual/ Institutional Investors and Licensed Custodians (whitelabel). Please contact us at support@atom8.com.hk for further information on our wallet solutions.",
  faq_title8 : "RegTech Solutions",
  faq_general_question35 : "What is the Financial Action Task Force (FATF)?",
  faq_general_answer35 : "The Financial Action Task Force (FATF) is an intergovernmental body who publishes the FATF Recommendations. The FATF Recommendations are not legally binding, but sets a global standard for authorities and regulators to follow when dealing with money laundering, terrorist financing, and other unlawful activities.",
  faq_general_question36 : "What is the current regulatory landscape for digital assets?",
  faq_general_answer36_1 : "With the rapidly growing crypto and digital asset market in mid-2010s, there had been a surge in Initial Coin Offering (ICOs) to raise funds. However, due in part to the large number of ICO scams, there was a shift towards regulating fundraising methodologies within the digital asset space. As a result, Security Token Offerings (STOs), where projects are asset-backed and legitimate, was introduced.",
  faq_general_answer36_2 : "Regulators and licensed entities globally are applying FATF standards on digital asset transactions, making the sector less anonymous but reducing illegal activities. They also follow the securities regulatory framework as stated by the International Organization of Securities Commissions (IOSCO), an international body upholding securities regulation.",
  faq_general_question37 : "How is a security token regulated in Hong Kong?",
  faq_general_answer37 : "Security tokens are regulated as securities under the Securities and Futures Ordinance (SFO) in Hong Kong by the SFC.",
  faq_general_question38 : "What is smart contract auditing? Why is it important?",
